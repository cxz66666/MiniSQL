...
SCAN:
	...
	case EOF:
		// Stop lex
	case IDENT, INTEGER,FLOAT,STRING, LEFT_PARENTHESIS, RIGHT_PARENTHESIS, COMMA, SEMICOLON, EQUAL, ANGLE_LEFT, ANGLE_RIGHT,ANGLE_LEFT_EQUAL,ANGLE_RIGHT_EQUAL,NOT_EQUAL,ASTERISK:
		result.Literal = lit
	case WS,APOSTROPNE:
		// Skip
		goto SCAN
